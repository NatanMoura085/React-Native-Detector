...
const Home = () => {
  ...
  const facesValues = useSharedValue({
    width: 0,
    height: 0,
    x: 0,
    y: 0
  ...
  const animatedStyle = useAnimatedStyle(() => ({
    position: 'absolute',
    zIndex: 1,
    width: facesValues.value.width,
    height: facesValues.value.height,
    transform: [
      { translateX: facesValues.value.x },
      { translateY: facesValues.value.y },
    ]
